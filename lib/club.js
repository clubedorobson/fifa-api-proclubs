...
const getfifa21ClubMemberStats = clubId => api.getfifa21(`clubs/${clubId}/membersComplete`);

const getfifa21ClubSeasonRank = clubId => api.getfifa21(`clubs/${clubId}/seasonRank`);

const getfifa21ClubSeasonStats = clubId => api.getfifa21(`clubs/${clubId}/seasonalStats`);

const getfifa21ClubStats = clubId => api.getfifa21(`clubs/${clubId}/stats`);

const getfifa21ClubMatchHistory = clubId => api.getfifa21(`clubs/${clubId}/matches`);

const getfifa21ClubInfo = clubId => api.getfifa21(`clubs/${clubId}/info`);
